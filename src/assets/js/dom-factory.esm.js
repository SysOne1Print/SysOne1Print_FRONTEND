        ...
        var o = n(4),
          ...
          f =
            ((e.watch = function () {
              ...
              var r = e[1]
              _(r) ? g.apply(void 0, e) : f(r) ? b.apply(void 0, e) : w.apply(void 0, e)
            }),
            (e.unwatch = function () {
              for (var t = arguments.length, e = Array(t), n = 0; t > n; n++) e[n] = arguments[n]
              var r = e[1]
          ...
          p = function (t, e, n, r, o) {
            var i = void 0,
              c = t.__watchers__[e]
            ;(i = t.__watchers__.__watchall__) && (c = c ? c.concat(i) : i)
            for (var a = c ? c.length : 0, f = 0; a > f; f++) c[f].call(t, n, r, e, o)
          },
          v = ['pop', 'push', 'reverse', 'shift', 'sort', 'unshift', 'splice'],
          h = function (t, e, n, r) {
            s(t, n, function () {
              for (
                var o = 0, i = void 0, c = void 0, a = arguments.length, f = Array(a), u = 0;
                a > u;
                u++
              )
                f[u] = arguments[u]
              if ('splice' === n) {
                var _ = f[0],
                  s = _ + f[1]
                ;(i = t.slice(_, s)), (c = [])
                for (var l = 2; l < f.length; l++) c[l - 2] = f[l]
                o = _
              } else
                c =
                  'push' === n || 'unshift' === n
          ...
          d = function (t, e) {
            if (_(e) && t && !(t instanceof String) && f(t))
              for (var n = v.length; n > 0; n--) {
                var r = v[n - 1]
                h(t, t[r], r, e)
              }
          },
          y = function (t, e, n, r) {
            ...
            void 0 === t.__watchers__ &&
              (s(t, '__watchers__', {}),
              c &&
                d(t, function (n, o, i, c) {
                  if ((p(t, n, i, c, o), 0 !== r && i && (u(i) || f(i)))) {
                    var a = void 0,
                      _ = t.__watchers__[e]
                    ;(a = t.__watchers__.__watchall__) && (_ = _ ? _.concat(a) : a)
                    for (var s = _ ? _.length : 0, l = 0; s > l; l++)
                      if ('splice' !== o) g(i, _[l], void 0 === r ? r : r - 1)
                      else
                        for (var v = 0; v < i.length; v++) g(i[v], _[l], void 0 === r ? r : r - 1)
                  }
                })),
              void 0 === t.__proxy__ && s(t, '__proxy__', {}),
              void 0 === t.__watchers__[e] && ((t.__watchers__[e] = []), c || (o = !0))
            for (var _ = 0; _ < t.__watchers__[e].length; _++)
              if (t.__watchers__[e][_] === n) return
              ...
              o &&
                !(function () {
                  ...
                  var o = function () {
                    ...
                    c = function (n) {
                      var o = t.__proxy__[e]
                      if (0 !== r && t[e] && (u(t[e]) || f(t[e])) && !t[e].__watchers__)
                        for (var i = 0; i < t.__watchers__[e].length; i++)
                          g(t[e], t.__watchers__[e][i], void 0 === r ? r : r - 1)
                      o !== n && ((t.__proxy__[e] = n), p(t, e, n, o, 'set'))
                    }
                  l(t, e, o, c)
                })()
          },
          g = function P(t, e, n) {
            if ('string' != typeof t && (t instanceof Object || f(t)))
              if (f(t)) {
                if ((y(t, '__watchall__', e, n), void 0 === n || n > 0))
                  for (var r = 0; r < t.length; r++) P(t[r], e, n)
              } else {
                var o = []
                for (var i in t) ({}).hasOwnProperty.call(t, i) && o.push(i)
                b(t, o, e, n)
              }
          },
          w = function (t, e, n, r) {
            'string' != typeof t &&
              (t instanceof Object || f(t)) &&
              (_(t[e]) ||
          ...
          O = function (t, e, n) {
            for (var r in e) e.hasOwnProperty(r) && x(t, e[r], n)
          },
          j = function S(t, e) {
            var n = []
            for (var r in t)
              t.hasOwnProperty(r) && (t[r] instanceof Object && S(t[r], e), n.push(r))
            O(t, n, e)
          },
          m = function (t, e) {
            if (!(t instanceof String || ((!t) instanceof Object && !f(t))))
              if (f(t)) {
...
const propValue = (prop, opts = {}, src, element) => {
  ...
  if (opts.type === Boolean) {
    src[prop] = opts.reflectToAttribute && element.dataset[prop] === 'false' ? false : opts.value
  ...
  const property = {
    ...
    set: function (value) {
      ...
      if (opts.type === Boolean || removable) {
        return this.element[!removable ? 'setAttribute' : 'removeAttribute'](
          propKebab,
          opts.type === Boolean ? '' : value
        )
      }
...
const factory = (factory, element) => {
  if (!factory || typeof factory !== 'object' || !isElement(element)) {
  ...
  component = assign({}, makeMixins(factory), factory, component)
